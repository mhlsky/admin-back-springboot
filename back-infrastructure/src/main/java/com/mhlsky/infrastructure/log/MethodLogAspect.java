package com.mhlsky.infrastructure.log;

import cn.hutool.json.JSONUtil;
import com.mhlsky.common.utils.jackson.JacksonUtil;
...
public class MethodLogAspect {
    @Pointcut("execution(public * com.mhlsky..db.*Service.*(..))")
