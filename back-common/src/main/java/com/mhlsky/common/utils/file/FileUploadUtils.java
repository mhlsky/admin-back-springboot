package com.mhlsky.common.utils.file;
...
import com.mhlsky.common.exception.error.ErrorCode.Business;
...
public class FileUploadUtils {
    ...
    public static String getFileAbsolutePath(String subDir, String fileName) {
        return AdminBackConfig.getFileBaseDir() + File.separator + subDir + File.separator + fileName;
